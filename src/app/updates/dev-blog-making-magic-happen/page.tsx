...
const markdownText = `# Dev. Blog 1: Making Magic Happen

What we wanted out of our magic system and how we've gone about getting it

***NOTE: We recommend reading our Hotrod Magic post before this one for a detailed rundown on the rules of the magic system. This post will focus more on what we wanted to get out of the system and why we adapted it from the source-material the way we did.***
...
## Next Month: Iteration in UX Design

We'll kick off June with an illustration of how our presentation of spell information has evolved from humble Google sheets stat blocks to the beautiful in-game indexes we have now. Today, we also dropped a pair of Rules in Focus posts detailing Anno Amagium's dice rolling systems! And Next week, we'll race through the most important bullet points of world history. 'Til then!
`;
