...
![Cosmology of Anno Amagium](/lp/blog/cosmology-reality.png)
...
![The Faed – The Ever-Shifting Realm of the Fair Folk](/lp/blog/cosmology-faed.png)
...
export default function DeepLoreCosmologyPage() {
  const isAvailable = new Date() >= new Date('2026-05-25T00:00:00');
      ...
      <main className="w-full h-full min-h-screen bg-[url('/lp/Update/bgroleplay.png')] bg-cover bg-center">
        <div className="w-full h-full min-h-screen bg-black/70 flex items-center justify-center p-8 pt-24">
          <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <p className="text-lg text-white/50">This post will be available on May 25, 2026.</p>
          </div>
        </div>
      </main>
    );
