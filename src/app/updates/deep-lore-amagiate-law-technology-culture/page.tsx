...
const PUBLISH_DATE = new Date('2026-05-18T00:00:00');

const markdownText = `# Deep Lore: Amagiate Law, Technology, and Culture
...
[Ruben's Inhibitor Tattoo Image]
...
Next Tuesday we will be discussing *Anno Amagium*'s cosmology. We will cover reality, the Faed, the dimensional Veil separating the two, other planes of existence, and the curious entities that inhabit each. Come Friday, we'll have a tell-all about the game's Attribute system to appease our rules-hounds in the audience. Don't miss it!
`;
      ...
      <main className="w-full h-full min-h-screen bg-[url('/lp/Update/bgroleplay.png')] bg-cover bg-center">
        <div className="w-full h-full min-h-screen bg-black/70 flex items-center justify-center p-8 pt-24">
          <div className="w-full max-w-[800px] text-center text-white">
            ...
            <p className="mt-4 text-lg text-white/70">This post will be available on May 18, 2026.</p>
          </div>
        </div>
      </main>
    );
