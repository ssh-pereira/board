...
![Five-on-Five Concerning Curricula](/lp/blog/curricula-img-1.png)
...
**Hank**: Soft Shields is excellent. It's an underexplored weapon class in general, and yeah, the fencing cape's ability to bind your opponent in this dance-like exchange—it could come straight out of *The Princess Bride*.
...
**Hank**: Yes! In the interest of full disclosure: I am the guy who plays *Zenless Zone Zero*. I just showed Evelyn to **Colin** and said "Can we do this?" he gave me this stare and I made the obvious clarification: "the darts and death string!" Then he was like "Oh! Yeah, we can totally do that."

![Evelyn Chevelier showing off her lunalux garrote from Zenless Zone Zero](/lp/blog/curricula-img-3.png)
...
**Hank: What has been the most difficult design challenge you've faced in *Anno Amagium*?**
...
![Nightingale's Healing Aura](/lp/blog/curricula-img-2.png)
...
**Colin**: For oddball builds, I want to see more mixed weaponry specific builds. Like something with an Elemental Weapon and an Anima Cannon. You often do a lot of elemental MDMG with each and the buffs from the Elemental Weapon curricula stack really nicely. Plus, who doesn't want to wield the Caster from *Outlaw Star*?
...
**Hank**: I think the prevalence of homebrew in Leading Brand TTRPGs says a lot about what players want. More personalization and originality. Characters who use unusual weapons or tactics that you have to run-by the GM before you can start the campaign. Outside of *Baldur's Gate 3*, I cannot remember playing a 5E or even a 3.5 campaign with anything other than a heavily homebrewed class or completely bespoke magic system. Hell, even in BG3, they have the Illithid stuff which is essentially the same thing. To say nothing of Durge! Anyway, I digress.

Really, I just love the feeling you get late-game in a *Final Fantasy* title where you have... dozens of distinct mechanical options. And I wanted to give players that rush right out of the gate. This is a bit apples-vs.-oranges, but imagine if you started a Metroidvania as if you were midway through the game in terms of power ups... and you still had the same kind of exponential growth to look forward to. This is our attempt to create the TTRPG version of that sensation.
...
***There you have it folks! A totally not-forced conversation between two dudes about a game they just happen to be developing. Let us know if you enjoyed this one, and we will do more like it!***
`;

export default function DevBlogConcerningCurriculaPage() {
  const isAvailable = new Date() >= new Date('2026-05-29T00:00:00');
      ...
      <main className="w-full h-full min-h-screen bg-[url('/lp/Update/bgroleplay.png')] bg-cover bg-center">
        <div className="w-full h-full min-h-screen bg-black/70 flex items-center justify-center p-8 pt-24">
          <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <p className="text-lg text-white/50">This post will be available on May 29, 2026.</p>
          </div>
        </div>
      </main>
    );
